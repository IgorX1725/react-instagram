...
## Objetivo:
O desafio da semana é desenvolver um *SPA (Single Page Application)* mobile-first do **Instagram** em React.

## Requisitos:
Nesta parte você deverá cuidar dos estados dos componentes, das requsições HTTP de cada Rota da aplicação e dos ciclos de vida dos componentes utilizando React Hooks e abordagem funcional, os seguintes requisitos devem ser cumpridos:
...
Para a organização das pastas e arquivos deverá utilizar os seguintes padrões:
